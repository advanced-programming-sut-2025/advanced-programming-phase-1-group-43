...
public class AncientFruit extends Plant {
    public String plantType = "AncientFruit";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 28;
    public int BaseSellPrice = 550;
    public int RegrowthTime = 7;
    public boolean idEdible = false;
    public int Energy = 0;
    public int Age = 0;
    public String Season = "All Except Winter";
    public boolean CanBecomeGiantPlant = false;

    public AncientFruit(String plantType, int XPlanting, int YPlanting) {
