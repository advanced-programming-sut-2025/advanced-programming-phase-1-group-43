...
public class GreenBean extends Plant {
    public String plantType = "GreenBean";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 10;
    ...
    public GreenBean(String plantType, int XPlanting, int YPlanting) {
