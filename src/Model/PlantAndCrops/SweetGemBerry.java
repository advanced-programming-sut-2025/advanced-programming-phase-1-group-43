...
public class SweetGemBerry extends Plant {
    public String plantType = "SweetGemBerry";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 24;
    public int BaseSellPrice = 3000;
    ...
    public SweetGemBerry(String plantType, int XPlanting, int YPlanting) {
