...
public class SummerSquash extends Plant {
    public String plantType = "SummerSquash";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 6;
    public int BaseSellPrice = 45;
    public int RegrowthTime = 3;
    public boolean idEdible = true;
    public int Energy = 63;
    public int Age = 0;
    public String Season = "Summer";
    public boolean CanBecomeGiantPlant = false;

    public SummerSquash(String plantType, int XPlanting, int YPlanting) {
