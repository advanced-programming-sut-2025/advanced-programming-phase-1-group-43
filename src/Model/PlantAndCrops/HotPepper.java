...
public class HotPepper extends Plant {
    public String plantType = "HotPepper";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 5;
    ...
    public HotPepper(String plantType, int XPlanting, int YPlanting) {
