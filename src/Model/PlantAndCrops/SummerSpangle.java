...
public class SummerSpangle extends Plant {
    public String plantType = "SummerSpangle";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 8;
    public int BaseSellPrice = 90;
    ...
    public SummerSpangle(String plantType, int XPlanting, int YPlanting) {
