...
public class BokChoy extends Plant {
    public String plantType = "BokChoy";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 4;
    ...
    public BokChoy(String plantType, int XPlanting, int YPlanting) {
