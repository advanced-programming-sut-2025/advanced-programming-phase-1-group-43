...
public class RedCabbage extends Plant {
    public String plantType = "RedCabbage";
    public int XPlanting = Integer.parseInt(null);
    public int YPlanting = Integer.parseInt(null);
    public int totalHarvestTime = 9;
    public int BaseSellPrice = 260;
    ...
    public RedCabbage(String plantType, int XPlanting, int YPlanting) {
